...
//    }
//
//    public Appointment(Pet pet, Member member, MedicalForm medicalForm, Partner partner, Date appointmentDate, Time appointmentTime, String memberName, String memberTel, boolean isWantBillInfo, String appointmentReason, String appointmentImage) {
//        this.pet = pet;
//        this.member = member;
