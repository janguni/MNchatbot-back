...
public class MedicalFormController {
    ...
    public ResponseEntity<MedicalFormDto> searchTotalHospitalList(@RequestBody MedicalFormDto medicalFormDto, Authentication authentication) throws ParseException {
