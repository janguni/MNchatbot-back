...
public class MedicalFormController {
    ...
    @GetMapping("/medicalForm/add")
    public ResponseEntity<MedicalFormDto> searchTotalHospitalList(@RequestBody MedicalFormDto medicalFormDto, Authentication authentication) {
